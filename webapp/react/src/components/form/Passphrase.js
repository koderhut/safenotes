...
const Passphrase = (props) => {
    ...
    const [passphrase, setPassword]               = useState(form.passphrase);
    const [confirmPassphrase, setConfirmPassword] = useState(form.passphrase);
    ...
    const validatePassphrase = () => {
        ...
        onChange({name: "passphrase", value: passphrase});
    };
